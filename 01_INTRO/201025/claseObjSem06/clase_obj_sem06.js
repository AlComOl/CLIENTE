...
console.log("alumno.ciclo.loquesea ", alumno.ciclo.descrip);
...
/*
let juan = {...carlos};
for (let prop in carlos){
    juan[prop] = carlos[prop];
}
*/
...
console.log("restCarlos === personaCarlos, ",restCarlos === carlos)//false
console.log("copiaCarlos === personaCarlos, ",copiaRefCarlos === carlos)//true
console.log("restCarlos.sobrina === carlos.sobrina? ", restCarlos.sobrina === carlos.sobrina)//true
// 
